<?php
/**
 * File for class MicrobiltCriminalReportStructGEOCode_Type
 ...
 */
/**
 * This class stands for MicrobiltCriminalReportStructGEOCode_Type originally named GEOCode_Type
 ...
 * @date 2016-06-30
 */
class MicrobiltCriminalReportStructGEOCode_Type extends MicrobiltCriminalReportStructAggregate
{
    /**
     * The MSACode4
     * Meta informations extracted from the WSDL
    ...
    {
        MicrobiltCriminalReportWsdlClass::__construct(array('MSACode4'=>$_mSACode4,'MSACode5'=>$_mSACode5,'StateCode'=>$_stateCode,'CountyCode'=>$_countyCode,'CensusTrackCode'=>$_censusTrackCode,'BlockCode'=>$_blockCode,'Latitude'=>$_latitude,'Longitude'=>$_longitude,'GEOCreatedDt'=>$_gEOCreatedDt,'Message'=>$_message),false);
    }
    /**
     * Get MSACode4 value
     * @return string|null

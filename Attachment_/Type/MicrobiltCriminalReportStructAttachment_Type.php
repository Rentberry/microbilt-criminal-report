<?php
/**
 * File for class MicrobiltCriminalReportStructAttachment_Type
 ...
 */
/**
 * This class stands for MicrobiltCriminalReportStructAttachment_Type originally named Attachment_Type
 ...
 * @date 2016-06-30
 */
class MicrobiltCriminalReportStructAttachment_Type extends MicrobiltCriminalReportStructAggregate
{
    /**
     * The ContentType
     * Meta informations extracted from the WSDL
     ...
     * @return MicrobiltCriminalReportStructAttachment_Type
     */
    public function __construct($_contentType = NULL,$_content = NULL,$_contentURL = NULL,$_contentSource = NULL,$_imageCaption = NULL)
    {
        MicrobiltCriminalReportWsdlClass::__construct(array('ContentType'=>$_contentType,'Content'=>$_content,'ContentURL'=>$_contentURL,'ContentSource'=>$_contentSource,'ImageCaption'=>$_imageCaption),false);
    }
    /**

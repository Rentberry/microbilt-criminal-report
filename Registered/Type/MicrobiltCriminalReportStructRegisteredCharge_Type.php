<?php
/**
 * File for class MicrobiltCriminalReportStructRegisteredCharge_Type
 ...
 */
/**
 * This class stands for MicrobiltCriminalReportStructRegisteredCharge_Type originally named RegisteredCharge_Type
 ...
 * @date 2016-06-30
 */
class MicrobiltCriminalReportStructRegisteredCharge_Type extends MicrobiltCriminalReportStructAggregate
{
    /**
     * The CommercialDates
     * Meta informations extracted from the WSDL
    ...
    {
        MicrobiltCriminalReportWsdlClass::__construct(array('CommercialDates'=>$_commercialDates,'Message'=>$_message),false);
    }
    /**

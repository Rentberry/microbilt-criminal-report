<?php
/**
 * File for class MicrobiltCriminalReportStructRegisteredChargesDetails_Type
 ...
 */
/**
 * This class stands for MicrobiltCriminalReportStructRegisteredChargesDetails_Type originally named RegisteredChargesDetails_Type
 ...
 * @date 2016-06-30
 */
class MicrobiltCriminalReportStructRegisteredChargesDetails_Type extends MicrobiltCriminalReportStructAggregate
{
    /**
     * The CommercialDates
     * Meta informations extracted from the WSDL
    ...
    {
        MicrobiltCriminalReportWsdlClass::__construct(array('CommercialDates'=>$_commercialDates,'CommercialAmounts'=>$_commercialAmounts,'OrgInfo'=>$_orgInfo,'Message'=>$_message,'RegState'=>$_regState,'FilingNum'=>$_filingNum,'FilingStatus'=>$_filingStatus),false);
    }
    /**

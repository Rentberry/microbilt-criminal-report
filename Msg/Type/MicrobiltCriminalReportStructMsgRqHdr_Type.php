<?php
/**
 * File for class MicrobiltCriminalReportStructMsgRqHdr_Type
 ...
 */
/**
 * This class stands for MicrobiltCriminalReportStructMsgRqHdr_Type originally named MsgRqHdr_Type
 ...
 * @date 2016-06-30
 */
class MicrobiltCriminalReportStructMsgRqHdr_Type extends MicrobiltCriminalReportWsdlClass
{
    /**
     * The MemberId
     * Meta informations extracted from the WSDL
    ...
    /**
     * The RequestType
     * @var MicrobiltCriminalReportEnumRequestType
     */
    public $RequestType;
    /**
     * The ReasonCode
     ...
     * @param MicrobiltCriminalReportEnumRequestType $_requestType
     ...
     * @return MicrobiltCriminalReportEnumRequestType|null
     */
     ...
     * @uses MicrobiltCriminalReportEnumRequestType::valueIsValid()
     * @param MicrobiltCriminalReportEnumRequestType $_requestType the RequestType
     * @return MicrobiltCriminalReportEnumRequestType
     */
    public function setRequestType($_requestType)
    {
        if(!MicrobiltCriminalReportEnumRequestType::valueIsValid($_requestType))
        {
            return false;
        }

<?php
/**
 * File for class MicrobiltCriminalReportStructSummary_Type
 ...
 */
/**
 * This class stands for MicrobiltCriminalReportStructSummary_Type originally named Summary_Type
 ...
 * @date 2016-06-30
 */
class MicrobiltCriminalReportStructSummary_Type extends MicrobiltCriminalReportStructAggregate
{
    /**
     * The BalanceAmt
     * Meta informations extracted from the WSDL
     ...
     * - maxOccurs : unbounded
     * - minOccurs : 0
     * @var MicrobiltCriminalReportStructOtherAmounts_Type
     */
    public $OtherAmounts;
    /**
     ...
     * - maxOccurs : unbounded
     * - minOccurs : 0
     * @var MicrobiltCriminalReportStructOtherPercentages_Type
     */
     ...
     * @param MicrobiltCriminalReportStructCompAmt_Type $_pastDueBalAmt
     * @param MicrobiltCriminalReportStructCompAmt_Type $_paymentAmt
     * @param MicrobiltCriminalReportStructCompAmt_Type $_realEstateBalAmt
     * @param MicrobiltCriminalReportStructCompAmt_Type $_realEstatePmtAmt
     * @param MicrobiltCriminalReportStructCompAmt_Type $_totalCreditLimitAmt
     ...
     * @param MicrobiltCriminalReportStructCurrencyAmount $_averageMonthlyPmtAmt
     * @param int $_derogCount
     * @param MicrobiltCriminalReportStructOtherAmounts_Type $_otherAmounts
     * @param MicrobiltCriminalReportStructOtherPercentages_Type $_otherPercentages
     * @return MicrobiltCriminalReportStructSummary_Type
     */
     ...
     * @param MicrobiltCriminalReportStructCompAmt_Type $_pastDueBalAmt the PastDueBalAmt
     * @return MicrobiltCriminalReportStructCompAmt_Type
     */
     ...
     * @param MicrobiltCriminalReportStructCompAmt_Type $_realEstateBalAmt the RealEstateBalAmt
     * @return MicrobiltCriminalReportStructCompAmt_Type
     */
     ...
     * @param MicrobiltCriminalReportStructCompAmt_Type $_realEstatePmtAmt the RealEstatePmtAmt
     * @return MicrobiltCriminalReportStructCompAmt_Type
     */
     ...
     * @param MicrobiltCriminalReportStructCompAmt_Type $_totalCreditLimitAmt the TotalCreditLimitAmt
     * @return MicrobiltCriminalReportStructCompAmt_Type
     */
     ...
     * @param MicrobiltCriminalReportStructCurrencyAmount $_averageMonthlyPmtAmt the AverageMonthlyPmtAmt
     ...
     * @return MicrobiltCriminalReportStructOtherAmounts_Type|null
     */
     ...
     * @param MicrobiltCriminalReportStructOtherAmounts_Type $_otherAmounts the OtherAmounts
     ...
     * @return MicrobiltCriminalReportStructOtherPercentages_Type|null
     */
     ...
     * @param MicrobiltCriminalReportStructOtherPercentages_Type $_otherPercentages the OtherPercentages

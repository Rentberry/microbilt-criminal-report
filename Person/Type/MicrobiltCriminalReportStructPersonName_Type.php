<?php
/**
 * File for class MicrobiltCriminalReportStructPersonName_Type
 ...
 */
/**
 * This class stands for MicrobiltCriminalReportStructPersonName_Type originally named PersonName_Type
 ...
 * @date 2016-06-30
 */
class MicrobiltCriminalReportStructPersonName_Type extends MicrobiltCriminalReportStructAggregate
{
    /**
     * The FullName
     * Meta informations extracted from the WSDL
     ...
     */
    public function __construct($_fullName = NULL,$_middleName = NULL,$_lastName = NULL,$_firstName = NULL,$_titlePrefix = NULL,$_nameSuffix = NULL,$_nickname = NULL,$_legalName = NULL,$_maidenName = NULL,$_officialTitle = NULL,$_initials = NULL,$_firstSeenDt = NULL,$_dtLastSeen = NULL)
    {
        MicrobiltCriminalReportWsdlClass::__construct(array('FullName'=>$_fullName,'MiddleName'=>$_middleName,'LastName'=>$_lastName,'FirstName'=>$_firstName,'TitlePrefix'=>$_titlePrefix,'NameSuffix'=>$_nameSuffix,'Nickname'=>$_nickname,'LegalName'=>$_legalName,'MaidenName'=>$_maidenName,'OfficialTitle'=>$_officialTitle,'Initials'=>$_initials,'FirstSeenDt'=>$_firstSeenDt,'DtLastSeen'=>$_dtLastSeen),false);
    }
    /**
     * Get FullName value
     * @return string|null

<?php
/**
 * File for class MicrobiltCriminalReportStructOrgId_Type
 ...
 */
/**
 * This class stands for MicrobiltCriminalReportStructOrgId_Type originally named OrgId_Type
 ...
 * @date 2016-06-30
 */
class MicrobiltCriminalReportStructOrgId_Type extends MicrobiltCriminalReportStructAggregate
{
    /**
     * The KOB
     * Meta informations extracted from the WSDL
    ...
    {
        MicrobiltCriminalReportWsdlClass::__construct(array('KOB'=>$_kOB,'Description'=>$_description,'SubscriberNum'=>$_subscriberNum,'BurMarket'=>$_burMarket,'BurSubMarket'=>$_burSubMarket,'CorpID'=>$_corpID),false);
    }
    /**
     * Get KOB value
     * @return string|null

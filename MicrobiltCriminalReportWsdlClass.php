<?php
/**
 * File for MicrobiltCriminalReportWsdlClass to communicate with SOAP service
 ...
 */
/**
 * MicrobiltCriminalReportWsdlClass to communicate with SOAP service
 * 
 * @package MicrobiltCriminalReport
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20150429-01
 * @date 2016-06-30
 */
class MicrobiltCriminalReportWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
    ...
    /**
     * Constructor
     * @uses MicrobiltCriminalReportWsdlClass::setLastError()
     * @uses MicrobiltCriminalReportWsdlClass::initSoapClient()
     * @uses MicrobiltCriminalReportWsdlClass::initInternArrayToIterate()
     * @uses MicrobiltCriminalReportWsdlClass::_set()
     ...
     * @return MicrobiltCriminalReportWsdlClass
     */
    ...
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'MicrobiltCriminalReportWsdlClass'))
            {
     ...
     * @uses MicrobiltCriminalReportClassMap::classMap()
     * @uses MicrobiltCriminalReportWsdlClass::getDefaultWsdlOptions()
     * @uses MicrobiltCriminalReportWsdlClass::getSoapClientClassName()
     * @uses MicrobiltCriminalReportWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('MicrobiltCriminalReportClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = MicrobiltCriminalReportClassMap::classMap();
     ...
     * If a class is named as {MicrobiltCriminalReport}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('MicrobiltCriminalReportSoapClient') && is_subclass_of('MicrobiltCriminalReportSoapClient','SoapClient'))
            return 'MicrobiltCriminalReportSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses MicrobiltCriminalReportWsdlClass::WSDL_CACHE_WSDL
     * @uses MicrobiltCriminalReportWsdlClass::WSDL_COMPRESSION
     * @uses MicrobiltCriminalReportWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses MicrobiltCriminalReportWsdlClass::WSDL_ENCODING
     * @uses MicrobiltCriminalReportWsdlClass::WSDL_EXCEPTIONS
     * @uses MicrobiltCriminalReportWsdlClass::WSDL_FEATURES
     * @uses MicrobiltCriminalReportWsdlClass::WSDL_LOGIN
     * @uses MicrobiltCriminalReportWsdlClass::WSDL_PASSWORD
     * @uses MicrobiltCriminalReportWsdlClass::WSDL_SOAP_VERSION
     * @uses MicrobiltCriminalReportWsdlClass::WSDL_STREAM_CONTEXT
     * @uses MicrobiltCriminalReportWsdlClass::WSDL_TRACE
     * @uses MicrobiltCriminalReportWsdlClass::WSDL_TYPEMAP
     * @uses MicrobiltCriminalReportWsdlClass::WSDL_URL
     * @uses MicrobiltCriminalReportWsdlClass::VALUE_WSDL_URL
     * @uses MicrobiltCriminalReportWsdlClass::WSDL_USER_AGENT
     * @uses MicrobiltCriminalReportWsdlClass::WSDL_PROXY_HOST
     * @uses MicrobiltCriminalReportWsdlClass::WSDL_PROXY_PORT
     * @uses MicrobiltCriminalReportWsdlClass::WSDL_PROXY_LOGIN
     * @uses MicrobiltCriminalReportWsdlClass::WSDL_PROXY_PASSWORD
     * @uses MicrobiltCriminalReportWsdlClass::WSDL_LOCAL_CERT
     * @uses MicrobiltCriminalReportWsdlClass::WSDL_PASSPHRASE
     * @uses MicrobiltCriminalReportWsdlClass::WSDL_AUTHENTICATION
     * @uses MicrobiltCriminalReportWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses MicrobiltCriminalReportWsdlClass::getSoapClient()
     * @uses MicrobiltCriminalReportWsdlClass::getFormatedXml()
     ...
     * @uses MicrobiltCriminalReportWsdlClass::getSoapClient()
     * @uses MicrobiltCriminalReportWsdlClass::convertStringHeadersToArray()
     ...
     * @uses MicrobiltCriminalReportWsdlClass::count()
     * @return int
     */
     ...
     * @uses MicrobiltCriminalReportWsdlClass::getInternArrayToIterate()
     ...
     * @see MicrobiltCriminalReportWsdlClass::offsetGet()
     * @uses MicrobiltCriminalReportWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses MicrobiltCriminalReportWsdlClass::getAttributeName()
     * @uses MicrobiltCriminalReportWsdlClass::__toString()
     * @uses MicrobiltCriminalReportWsdlClass::_set()
     * @uses MicrobiltCriminalReportWsdlClass::_get()
     * @uses MicrobiltCriminalReportWsdlClass::setInternArrayToIterate()
     * @uses MicrobiltCriminalReportWsdlClass::setInternArrayToIterateIsArray()
     * @uses MicrobiltCriminalReportWsdlClass::setInternArrayToIterateOffset()
     ...
     * @uses MicrobiltCriminalReportWsdlClass::item()
     * @return mixed
     */
     ...
     * @uses MicrobiltCriminalReportWsdlClass::item()
     * @uses MicrobiltCriminalReportWsdlClass::length()
     * @return mixed
     */

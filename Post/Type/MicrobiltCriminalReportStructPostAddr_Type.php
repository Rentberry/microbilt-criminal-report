<?php
/**
 * File for class MicrobiltCriminalReportStructPostAddr_Type
 ...
 */
/**
 * This class stands for MicrobiltCriminalReportStructPostAddr_Type originally named PostAddr_Type
 ...
 * @date 2016-06-30
 */
class MicrobiltCriminalReportStructPostAddr_Type extends MicrobiltCriminalReportStructAggregate
{
    /**
     * The PreDirection
     * Meta informations extracted from the WSDL
     ...
     * - maxOccurs : 1
     * - minOccurs : 0
     * @var MicrobiltCriminalReportStructGEOCode_Type
     */
    public $GEOCode;
    /**
     * The AddrCreatedDt
     ...
     * @param MicrobiltCriminalReportStructGEOCode_Type $_gEOCode
     ...
     */
    public function __construct($_preDirection = NULL,$_addr4 = NULL,$_streetName = NULL,$_streetNum = NULL,$_streetType = NULL,$_unitType = NULL,$_apt = NULL,$_postDirection = NULL,$_addr1 = NULL,$_addr2 = NULL,$_addr3 = NULL,$_city = NULL,$_stateProv = NULL,$_postalCode = NULL,$_county = NULL,$_country = NULL,$_addrType = NULL,$_startDt = NULL,$_endDt = NULL,$_ownershipCode = NULL,$_reportedDt = NULL,$_addrSource = NULL,$_gEOCode = NULL,$_addrCreatedDt = NULL,$_lengthOfResidence = NULL,$_dropPointInd = NULL,$_dwellingUnitSize = NULL,$_urbanization = NULL,$_building = NULL)
    {
        MicrobiltCriminalReportWsdlClass::__construct(array('PreDirection'=>$_preDirection,'Addr4'=>$_addr4,'StreetName'=>$_streetName,'StreetNum'=>$_streetNum,'StreetType'=>$_streetType,'UnitType'=>$_unitType,'Apt'=>$_apt,'PostDirection'=>$_postDirection,'Addr1'=>$_addr1,'Addr2'=>$_addr2,'Addr3'=>$_addr3,'City'=>$_city,'StateProv'=>$_stateProv,'PostalCode'=>$_postalCode,'County'=>$_county,'Country'=>$_country,'AddrType'=>$_addrType,'StartDt'=>$_startDt,'EndDt'=>$_endDt,'OwnershipCode'=>$_ownershipCode,'ReportedDt'=>$_reportedDt,'AddrSource'=>$_addrSource,'GEOCode'=>$_gEOCode,'AddrCreatedDt'=>$_addrCreatedDt,'LengthOfResidence'=>$_lengthOfResidence,'DropPointInd'=>$_dropPointInd,'DwellingUnitSize'=>$_dwellingUnitSize,'Urbanization'=>$_urbanization,'Building'=>$_building),false);
    }
    /**
    ...
    /**
     * Get GEOCode value
     * @return MicrobiltCriminalReportStructGEOCode_Type|null
     */
    ...
    /**
     * Set GEOCode value
     * @param MicrobiltCriminalReportStructGEOCode_Type $_gEOCode the GEOCode

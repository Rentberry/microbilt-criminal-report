<?php
/**
 * File for class MicrobiltCriminalReportStructEvictionsCase_Type
 ...
 */
/**
 * This class stands for MicrobiltCriminalReportStructEvictionsCase_Type originally named EvictionsCase_Type
 ...
 * @date 2016-06-30
 */
class MicrobiltCriminalReportStructEvictionsCase_Type extends MicrobiltCriminalReportStructAggregate
{
    /**
     * The CaseId
     * Meta informations extracted from the WSDL
     ...
     * @param MicrobiltCriminalReportStructMessage_Type $_evictionsData
     ...
     * @return MicrobiltCriminalReportStructEvictionsCase_Type
     */
     ...
     * @param MicrobiltCriminalReportStructMessage_Type $_evictionsData the EvictionsData

<?php
/**
 * File for class MicrobiltCriminalReportStructACHInfo_Type
 ...
 */
/**
 * This class stands for MicrobiltCriminalReportStructACHInfo_Type originally named ACHInfo_Type
 ...
 * @date 2016-06-30
 */
class MicrobiltCriminalReportStructACHInfo_Type extends MicrobiltCriminalReportStructAggregate
{
    /**
     * The CheckRoutingNum
     * Meta informations extracted from the WSDL
    ...
    {
        MicrobiltCriminalReportWsdlClass::__construct(array('CheckRoutingNum'=>$_checkRoutingNum,'CheckAcctNum'=>$_checkAcctNum,'CheckAcctType'=>$_checkAcctType,'CheckNum'=>$_checkNum,'CheckEntryClassCd'=>$_checkEntryClassCd,'CheckDt'=>$_checkDt,'ACHPaymentType'=>$_aCHPaymentType),false);
    }
    /**

<?php
/**
 * File for class MicrobiltCriminalReportStructPhysicalCharacteristics_Type
 ...
 */
/**
 * This class stands for MicrobiltCriminalReportStructPhysicalCharacteristics_Type originally named PhysicalCharacteristics_Type
 ...
 * @date 2016-06-30
 */
class MicrobiltCriminalReportStructPhysicalCharacteristics_Type extends MicrobiltCriminalReportStructAggregate
{
    /**
     * The Age
     * Meta informations extracted from the WSDL
     ...
     * @param MicrobiltCriminalReportEnumBoolean $_correctiveLenses
    ...
    {
        MicrobiltCriminalReportWsdlClass::__construct(array('Age'=>$_age,'Race'=>$_race,'Ethnicity'=>$_ethnicity,'Gender'=>$_gender,'HairColor'=>$_hairColor,'EyeColor'=>$_eyeColor,'Height'=>$_height,'Weight'=>$_weight,'SkinTone'=>$_skinTone,'BuildType'=>$_buildType,'IdentifyingMarks'=>$_identifyingMarks,'ShoeSize'=>$_shoeSize,'CorrectiveLenses'=>$_correctiveLenses),false);
    }
    /**
     * Get Age value
     * @return string|null
     ...
     * @param MicrobiltCriminalReportEnumBoolean $_correctiveLenses the CorrectiveLenses
     * @return MicrobiltCriminalReportEnumBoolean
     */
    public function setCorrectiveLenses($_correctiveLenses)
    {
        if(!MicrobiltCriminalReportEnumBoolean::valueIsValid($_correctiveLenses))
        {
            return false;
        }

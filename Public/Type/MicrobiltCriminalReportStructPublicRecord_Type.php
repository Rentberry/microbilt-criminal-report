<?php
/**
 * File for class MicrobiltCriminalReportStructPublicRecord_Type
 ...
 */
/**
 * This class stands for MicrobiltCriminalReportStructPublicRecord_Type originally named PublicRecord_Type
 ...
 * @date 2016-06-30
 */
class MicrobiltCriminalReportStructPublicRecord_Type extends MicrobiltCriminalReportStructAggregate
{
    /**
     * The CaseId
     * Meta informations extracted from the WSDL
     ...
     * - maxOccurs : unbounded
     * - minOccurs : 0
     * @var MicrobiltCriminalReportStructCourtInfo_Type
     */
    public $CourtInfo;
    /**
     * The Message
     ...
     * @param MicrobiltCriminalReportStructCurrencyAmount $_bankruptcyAssetsAmt
     * @param MicrobiltCriminalReportStructCurrencyAmount $_bankruptcyLiabilitiesAmt
     ...
     * @param MicrobiltCriminalReportStructCurrencyAmount $_bankruptcyAssetsAmt the BankruptcyAssetsAmt
     ...
     * @param MicrobiltCriminalReportStructCurrencyAmount $_bankruptcyLiabilitiesAmt the BankruptcyLiabilitiesAmt
     * @return MicrobiltCriminalReportStructCurrencyAmount
     */
     ...
     * @param MicrobiltCriminalReportStructCurrencyAmount $_legalObligationAmt the LegalObligationAmt
     * @return MicrobiltCriminalReportStructCurrencyAmount
     */
     ...
     * @uses MicrobiltCriminalReportEnumBoolean::valueIsValid()
     * @param MicrobiltCriminalReportEnumBoolean $_manualUpdInd the ManualUpdInd
     * @return MicrobiltCriminalReportEnumBoolean
     */
    public function setManualUpdInd($_manualUpdInd)
    {
        if(!MicrobiltCriminalReportEnumBoolean::valueIsValid($_manualUpdInd))
        {
            return false;
        }
     ...
     * @uses MicrobiltCriminalReportEnumBoolean::valueIsValid()
     * @param MicrobiltCriminalReportEnumBoolean $_voluntaryInd the VoluntaryInd
     * @return MicrobiltCriminalReportEnumBoolean
     */
    public function setVoluntaryInd($_voluntaryInd)
    {
        if(!MicrobiltCriminalReportEnumBoolean::valueIsValid($_voluntaryInd))
        {
            return false;
        }
    ...
    /**
     * Set ClaimAmt value
     * @param MicrobiltCriminalReportStructCurrencyAmount $_claimAmt the ClaimAmt
     * @return MicrobiltCriminalReportStructCurrencyAmount
     */
    ...
    /**
     * Get CourtInfo value
     * @return MicrobiltCriminalReportStructCourtInfo_Type|null
     */
    ...
    /**
     * Set CourtInfo value
     * @param MicrobiltCriminalReportStructCourtInfo_Type $_courtInfo the CourtInfo
     * @return MicrobiltCriminalReportStructCourtInfo_Type
     */

<?php
/**
 * File for class MicrobiltCriminalReportStructCollateralInfo_Type
 ...
 */
/**
 * This class stands for MicrobiltCriminalReportStructCollateralInfo_Type originally named CollateralInfo_Type
 ...
 * @date 2016-06-30
 */
class MicrobiltCriminalReportStructCollateralInfo_Type extends MicrobiltCriminalReportStructAggregate
{
    /**
     * The CollateralDesc
     * Meta informations extracted from the WSDL
     ...
     * @param MicrobiltCriminalReportStructPostAddr_Type $_propertyAddress
     ...
     * @param MicrobiltCriminalReportStructPostAddr_Type $_propertyAddress the PropertyAddress

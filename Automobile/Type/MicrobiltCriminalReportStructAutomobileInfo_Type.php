<?php
/**
 * File for class MicrobiltCriminalReportStructAutomobileInfo_Type
 ...
 */
/**
 * This class stands for MicrobiltCriminalReportStructAutomobileInfo_Type originally named AutomobileInfo_Type
 ...
 * @date 2016-06-30
 */
class MicrobiltCriminalReportStructAutomobileInfo_Type extends MicrobiltCriminalReportStructAggregate
{
    /**
     ...
     * - maxOccurs : unbounded
     * - minOccurs : 0
     * @var MicrobiltCriminalReportStructAutomobileExtras_Type
     */
     ...
     * - maxOccurs : unbounded
     * - minOccurs : 0
     * @var MicrobiltCriminalReportStructLienHolderInfo_Type
     */
    ...
    /**
     * Set FuelType value
     * @param MicrobiltCriminalReportStructCodeDescription_Type $_fuelType the FuelType
     ...
     * @param MicrobiltCriminalReportStructCodeDescription_Type $_vehicleUse the VehicleUse
     * @return MicrobiltCriminalReportStructCodeDescription_Type
     */
     ...
     * @param MicrobiltCriminalReportStructCodeDescription_Type $_motorVehicleRegistrationOption the MotorVehicleRegistrationOption
     * @return MicrobiltCriminalReportStructCodeDescription_Type
     */
     ...
     * @param MicrobiltCriminalReportStructCodeDescription_Type $_majorColor the MajorColor
     * @return MicrobiltCriminalReportStructCodeDescription_Type
     */
     ...
     * @param MicrobiltCriminalReportStructCodeDescription_Type $_minorColor the MinorColor
     * @return MicrobiltCriminalReportStructCodeDescription_Type
     */
    ...
    /**
     * Set Body value
     * @param MicrobiltCriminalReportStructCodeDescription_Type $_body the Body
     * @return MicrobiltCriminalReportStructCodeDescription_Type
     */
     ...
     * @param MicrobiltCriminalReportStructDateRange_Type $_effectiveDtRange the EffectiveDtRange
     ...
     * @return MicrobiltCriminalReportStructAutomobileExtras_Type|null
     */
     ...
     * @param MicrobiltCriminalReportStructAutomobileExtras_Type $_automobileExtras the AutomobileExtras
     ...
     * @return MicrobiltCriminalReportStructLienHolderInfo_Type|null
     */
     ...
     * @param MicrobiltCriminalReportStructLienHolderInfo_Type $_lienHolderInfo the LienHolderInfo
     ...
     * @param MicrobiltCriminalReportEnumBoolean $_newVehicleInd the NewVehicleInd
     * @return MicrobiltCriminalReportEnumBoolean
     */
    public function setNewVehicleInd($_newVehicleInd)
    {
        if(!MicrobiltCriminalReportEnumBoolean::valueIsValid($_newVehicleInd))
        {
            return false;
        }

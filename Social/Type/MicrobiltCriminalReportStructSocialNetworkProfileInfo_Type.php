<?php
/**
 * File for class MicrobiltCriminalReportStructSocialNetworkProfileInfo_Type
 ...
 */
/**
 * This class stands for MicrobiltCriminalReportStructSocialNetworkProfileInfo_Type originally named SocialNetworkProfileInfo_Type
 ...
 * @date 2016-06-30
 */
class MicrobiltCriminalReportStructSocialNetworkProfileInfo_Type extends MicrobiltCriminalReportStructAggregate
{
    /**
     * The ProfileSite
     * Meta informations extracted from the WSDL
     ...
     * @return MicrobiltCriminalReportStructSocialNetworkProfileInfo_Type
     */
    ...
    {
        MicrobiltCriminalReportWsdlClass::__construct(array('ProfileSite'=>$_profileSite,'ProfileURL'=>$_profileURL,'PublicURL'=>$_publicURL,'ProfileRegion'=>$_profileRegion,'UserID'=>$_userID,'UserName'=>$_userName,'MembershipDt'=>$_membershipDt,'LastActivityDt'=>$_lastActivityDt),false);
    }
    /**

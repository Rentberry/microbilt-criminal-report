<?php
/**
 * File for class MicrobiltCriminalReportStructOffenderRef_Type
 ...
 */
/**
 * This class stands for MicrobiltCriminalReportStructOffenderRef_Type originally named OffenderRef_Type
 ...
 * @date 2016-06-30
 */
class MicrobiltCriminalReportStructOffenderRef_Type extends MicrobiltCriminalReportStructAggregate
{
    /**
     * The OffenderID
     * Meta informations extracted from the WSDL
    ...
    {
        MicrobiltCriminalReportWsdlClass::__construct(array('OffenderID'=>$_offenderID,'DOCNum'=>$_dOCNum,'SORNum'=>$_sORNum,'StateIDNum'=>$_stateIDNum,'FBINum'=>$_fBINum,'NCICNum'=>$_nCICNum,'FingerprintOnFile'=>$_fingerprintOnFile),false);
    }
    /**
